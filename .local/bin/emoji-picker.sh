...
if [ $? -eq 0 ]
then
    sed '1,/^### DATA ###$/d' $0 | tofi | cut -d ' ' -f 1 | tr -d '\n' | wtype -
else
    sed '1,/^### DATA ###$/d' $0 | tofi | cut -d ' ' -f 1 | tr -d '\n' | wl-copy
fi
exit
...
(╥_╥) cry emoticon
( ͡° ͜ʖ ͡°) lenny face emoticon
( ༎ຶ ۝ ༎ຶ ) anguish cry emoticon
ヽ༼ຈل͜ຈ༽ﾉ raise your dongers emoticon
(๑ˇεˇ๑) kiss emoticon mwah
ᕕ( ᐛ )ᕗ happy gary emoticon
ಠ益ಠ angry disapproval emoticon
😀 grinning face face smile happy joy :D grin
😃 grinning face with big eyes face happy joy haha :D :) smile funny
🤮 face with puke throw up disgust
...
🤧 sneezing face face gesundheit sneeze sick allergy blow nose
...
😭 loudly crying face face cry tears sad upset depressed laugh
